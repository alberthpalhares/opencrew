# opencrew Skill Format Reference

## SKILL.md Structure

Every opencrew skill consists of a `SKILL.md` file with YAML frontmatter and a Markdown body.
...
Use this skill when the user or crew pipeline needs to create visual content — social media posts, presentations, flyers, or any graphic design task that benefits from Canva's template library.
...
description: Write content in a professional corporate tone. Use when crew agents need to produce business communications, reports, or client-facing materials that require formal, polished language.
type: prompt
version: 1.0.0
categories:
  - writing
...
description: Draft social media content and publish via API. Use when crews need to create and post content to Instagram, Twitter/X, or LinkedIn with approval workflows.
type: hybrid
version: 1.0.0
categories:
  - social-media
...
1. Draft the content using crew agent context (topic, tone, audience)
