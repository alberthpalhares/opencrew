...
1. Design a compelling thumbnail concept (face, emotion, high contrast, 3-4 words max) before scripting.
2. Craft titles (50-70 characters) that combine a curiosity gap with a specific benefit, front-loading keywords.
3. Write a strong hook for the first 30 seconds that establishes stakes without asking for likes/subs.
4. Structure the body into 3-5 distinct sections with clear subheadings and logical flow.
5. Incorporate pattern interrupt cues (B-roll, graphics, angle changes) every 30-60 seconds.
6. Position the climax or key "aha" insight at 60-70% through the video duration.
7. Keep total estimated video duration in the optimal 8-15 minute range.
8. Include exactly one primary CTA in the final 20 seconds, utilizing end screen elements.
9. Provide timestamps in the description for chapter navigation.
10. Ensure the first two lines of the description contain the hook and primary keywords.
11. Use conversational language suited for spoken delivery with short, punchy sentences.
12. Recap key points briefly at the end to reinforce the primary takeaway before the CTA.
