...
1. Craft hooks that fit within the first 210 characters to compel the "see more" tap.
2. Structure text posts with a hook, context story, 3-5 insights, a takeaway, and a CTA question.
3. Write in the first person using short paragraphs (1-2 sentences maximum).
4. Never place external links in the post body; use the "link in comments" approach.
5. End every post with a genuine, specific question to drive comments.
6. Limit tags to 2-3 people who will actively engage; avoid spam tagging.
7. Use exactly 3-5 relevant hashtags placed on the final line, separate from the body text.
8. Opt for document/carousel formats (10-15 slides) over text-only when possible for higher reach.
9. Reply to every comment received on your posts to signal quality to the algorithm.
10. Limit publishing to a maximum of 1 post per day.
11. Post on weekdays between 7-9 AM or 12-1 PM (audience time zone); avoid weekends.
12. Do not edit the post within the first 10 minutes of publishing.
