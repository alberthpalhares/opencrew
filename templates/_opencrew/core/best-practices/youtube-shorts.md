...
1. Capture attention in the first 0-2 seconds with a strong visual or spoken hook.
2. Keep the total duration between 15-45 seconds to maximize completion rate and replays.
3. Focus on exactly one point, story, or tip per Short; avoid multi-point delivery.
4. Include burned-in text overlays throughout for viewers watching with sound off.
5. Design the ending to seamlessly loop back to the opening hook visually or narratively.
6. Shoot natively in vertical (9:16) format; never crop horizontal footage.
7. Always include "#Shorts" in the title or description for proper feed categorization.
8. Maintain a fast, energetic pace and eliminate all filler words from the script.
9. Write a concise, curiosity-driven title that will appear in the browse feed.
10. Include 3-5 relevant hashtags in the description to assist with categorization.
11. Use visual variety with cuts or angle changes every 3-5 seconds during delivery.
12. Avoid slow intros, logos, or greetings; jump straight into the value.
