...
1. Match search intent precisely before writing any content.
2. Write comprehensive content of 2,000-3,000 words for competitive keywords.
3. Front-load the primary keyword in the first 40 characters of the title tag.
4. Keep keyword density between 1-2% of total word count.
5. Include the primary keyword naturally within the first 100 words.
6. Use the primary keyword in 2-3 H2 subheadings, varying with synonyms.
7. Add an FAQ section with 40-60 word answers to target featured snippets.
8. Include at least 3 internal links with descriptive anchor text.
9. Add 2+ external links to authoritative, relevant sources.
10. Add descriptive alt text to every image, incorporating keywords naturally.
11. Structure with 5-8 H2 sections and subheadings every 200-300 words.
12. Write for an 8th-grade reading level (Flesch-Kincaid 60+) using short sentences.
13. Avoid keyword stuffing above 3% density or duplicate content.
14. Update published content quarterly to maintain freshness and rankings.
