...
1. Draft the hook first; spend 50% of your energy on the opening line.
2. Base all copy on a pre-writing diagnosis of audience awareness and market sophistication.
3. Lead with emotional resonance before logic (fear, desire, belonging).
4. Include a clear, specific CTA in every piece of copy.
...
12. Match CTA intensity to the funnel stage (soft for awareness, hard for conversion).
13. Respect platform-specific constraints (e.g., Instagram's "...more" fold).
14. Edit ruthlessly: reduce word count by 15-25% to eliminate filler.
15. Never use cliches, passive voice CTAs, or unbroken walls of text.
